package strayfurther.backend.config.stub;
...
@Profile("prod")
public class StubAmazonS3 implements AmazonS3 {

    private final Map<String, Map<String, S3Object>> storage = new HashMap<>();

    @Override
    public void setEndpoint(String endpoint) {
        throw new UnsupportedOperationException("setEndpoint is not supported in StubAmazonS3");
    }

    @Override
    public PutObjectResult putObject(String bucketName, String key, InputStream input, ObjectMetadata metadata) {
        storage.computeIfAbsent(bucketName, k -> new HashMap<>());
        S3Object s3Object = new S3Object();
        s3Object.setObjectContent(input);
        storage.get(bucketName).put(key, s3Object);
    ...
    public S3Object getObject(String bucketName, String key) {
        if (storage.containsKey(bucketName) && storage.get(bucketName).containsKey(key)) {
            return storage.get(bucketName).get(key);
        }
        throw new AmazonS3Exception("Object not found in bucket: " + bucketName + " with key: " + key);
    }
    ...
    public void deleteObject(String bucketName, String key) {
        if (storage.containsKey(bucketName)) {
            storage.get(bucketName).remove(key);
        }
    }
    ...
    public String getBucketLocation(String bucketName) {
        return "us-east-1"; // Stubbed region
    }
    ...
    @Override
    public Bucket createBucket(String s, Region region) throws SdkClientException, AmazonServiceException {
        return null;
    }
    ...
    public boolean doesBucketExistV2(String bucketName) {
        return storage.containsKey(bucketName);
    }
    ...
    public ObjectListing listObjects(String bucketName) {
        throw new UnsupportedOperationException("listObjects is not implemented in StubAmazonS3");
    }
    ...
    // Implement other required methods with UnsupportedOperationException
    @Override
    public void shutdown() {
        throw new UnsupportedOperationException("shutdown is not supported in StubAmazonS3");
    }
    ...
    public void setRegion(com.amazonaws.regions.Region region) {
        throw new UnsupportedOperationException("setRegion is not supported in StubAmazonS3");
    }
    ...
    @Override
    public com.amazonaws.services.s3.model.InitiateMultipartUploadResult initiateMultipartUpload(InitiateMultipartUploadRequest request) {
        throw new UnsupportedOperationException("initiateMultipartUpload is not supported in StubAmazonS3");
    }
